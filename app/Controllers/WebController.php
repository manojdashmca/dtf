...
class WebController extends BaseController {
    ...
    public function __construct() {
        ...
        $openmethods = array('division-dashboard','getHomePipeMeterConDivision','pipeDashboard', 'deleteSystemLogs', 'deleteEmailAttachment', 'login', 'logout', 'forgotpassord', 'resetpassord');
