...
class WebController extends BaseController {
    ...
    public function __construct() {
        ...
        $openmethods = array('divisionDishboard','getHomePipeMeterConDivision','pipeDashboard', 'deleteSystemLogs', 'deleteEmailAttachment', 'login', 'logout', 'forgotpassord', 'resetpassord');
