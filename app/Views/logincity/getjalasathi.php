                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                <p class="text-uppercase fw-medium text-muted text-truncate fs-13">Nos.of Jalsathi</p>
                                <h4 class="fs-22 fw-semibold mb-3"><?= isset($allJalasathifilter->no_of_jalasathi) ? $allJalasathifilter->no_of_jalasathi : '0'; ?></h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="fs-22 fw-semibold mb-3"><?= isset($allJalasathifilter->revenue_collected_by_jalasathi) ? $allJalasathifilter->revenue_collected_by_jalasathi : '0'; ?></h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="fs-22 fw-semibold mb-3"><?= isset($allJalasathifilter->incentive_paid_to_jalsathi) ? $allJalasathifilter->incentive_paid_to_jalsathi : '0'; ?></h4>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <div class="flex-grow-1">
                                ...
                                <h4 class="fs-22 fw-semibold mb-3"><?= isset($allJalasathifilter->no_of_test_conducted_by_jalasathi) ? $allJalasathifilter->no_of_test_conducted_by_jalasathi : '0'; ?></h4>
