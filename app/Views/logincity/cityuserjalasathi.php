                        ...
                        <div class="col-lg-12">
                            <div class="card card-light">
                                <div class="card-header">
                                    <h4 class="card-title mb-0">ADD A NEW INCENTIVE DETAILS </h4>
                                </div><!-- end card header -->
                                <div class="card-body text-black">
                                    <div class="row gy-4">
                                        <div class="col-8">
                                            <div class="row">
                                                <div class="col-12">
                                                    <label for="basiInput" class="form-label">Word Number: </label>
                                                    <textarea class="form-control" id="exampleFormControlTextarea5" rows="1"></textarea>
                                                </div>

                                                <div class="col-6">
                                                    <label for="basiInput" class="form-label">Name of the MSG/SHG</label>
                                                    <input type="text" class="form-control form-control-sm" id="basiInput">
                                                </div>
                                                <div class="col-6">
                                                    <label for="basiInput" class="form-label">Name of the Jalasathi</label>
                                                    <input type="text" class="form-control form-control-sm" id="basiInput">
                                                </div>
                                                <div class="col-6">
                                                    <label for="basiInput" class="form-label">PAN No</label>
                                                    <input type="text" class="form-control form-control-sm" id="basiInput">
                                                </div>
                                                <div class="col-6">
                                                    <label for="basiInput" class="form-label">Bank Account No</label>
                                                    <input type="text" class="form-control form-control-sm" id="basiInput">
                                                </div>
                                                <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    <label for="basiInput" class="form-label">Bank Name and Branch</label>
                                                    <input type="text" class="form-control form-control-sm" id="basiInput">
                                                </div>
                                                <div class="col-6">
                                                </div>
                                                <div class="col-6">
                                                    <label for="basiInput" class="form-label">Collection by Jalasathi (Mpos)</label>
                                                    <input type="text" class="form-control form-control-sm" id="basiInput">
                                                </div>
                                                <div class="col-6">
                                                </div>
                                                <div class="col-6">
                                                    <label for="basiInput" class="form-label">Total Incentive of Jalasathi (Rs.)</label>
                                                    <input type="text" class="form-control form-control-sm" id="basiInput">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-4">
                                            <div class="card card-light">
                                                <div class="card-header text-center">
                                                    <h4 class="card-title mb-0">Incentive Break Up</h4>
                                                </div>
                                                <div class="card-body text-black">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <label for="basiInput" class="form-label" style="font-size:small;">5% Incentive From water charges</label>
                                                            <input type="text" class="form-control form-control-sm" id="basiInput">
                                                        </div>
                                                        <div class="col-12">
                                                            <label for="basiInput" class="form-label" style="font-size:small;">No New Water Supply Connection</label>
                                                            <input type="text" class="form-control form-control-sm" id="basiInput">
                                                        </div>
                                                        <div class="col-12">
                                                            <label for="basiInput" class="form-label" style="font-size:small;">Total Amount of new Water connection :Rs 100</label>
                                                            <input type="text" class="form-control form-control-sm" id="basiInput">
                                                        </div>
                                                        <div class="col-12">
                                                            <label for="basiInput" class="form-label" style="font-size:small;">Total No of Water Quality Tests</label>
                                                            <input type="text" class="form-control form-control-sm" id="basiInput">
                                                        </div>
                                                        <div class="col-12">
                                                            <label for="basiInput" class="form-label" style="font-size:small;">Water Quality tests (Nos of test * Rs.20/-)</label>
                                                            <input type="text" class="form-control form-control-sm" id="basiInput">
                                                        </div>
                                                    </div>
                                                </div>
