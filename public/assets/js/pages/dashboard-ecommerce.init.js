...
var worldlinemap,
        ...
        (linechartcustomerColors &&
                ((options = {
                    series: [
                        {name: "Achieved Progress", type: "area", data: [49389495.07, 13987196.83,83656382.23,11793846.34,9193421.44,10792470.29,53569846.70,85521525.55,46304870.52,23362949.78,108298253.39,6005038.57,14333283.16,20229505.79]},
                        {name: "Contract Cost", type: "bar", data: [676755890.00, 788357550.00, 670482457.00,81224095.00,215268240.00,710218514.00,433761287.00,748123512.00,374550002.00,159847074.00,774451667.00,352399618.00,220311433.00,594399992.00]},
                    ...
                    xaxis: {categories: ["Anandapur", "Barbil", "Biramitrapur", "Baripada", "Champua", "Joda", "Karanjia", "Keonjhar", "Rairangpur", "Rajgangpur", "Rourkela", "Sundargarh","Udala","Vyasanagar"], axisTicks: {show: !1}, axisBorder: {show: !1}},
                        ...
                        y: [
                            {
                                formatter: function (e) {
                                    return void 0 !== e ? "&#8377 " + e.toFixed(2) : e;
                                },
                            },
                            {
                                formatter: function (e) {
        ...
        (layoutRightSideBtn &&
            ...
            1 == document.querySelector(".layout-rightside-col").classList.contains("d-block") && document.querySelector(".layout-rightside-col").classList.remove("d-block");
                ...
                new Swiper(".selling-product", {slidesPerView: "auto", spaceBetween: 15, autoplay: {delay: 2500, disableOnInteraction: !1}, navigation: {nextEl: ".swiper-button-next", prevEl: ".swiper-button-prev"}})),
